...
def main() -> int:
    ...
    print("available endpoints: /api/health /api/status /api/settings /api/data/status /api/models/latest /api/tasks /api/predictions /api/backtests /api/reports /api/pipeline")
    try:
