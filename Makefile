.PHONY: help config progress akshare-universe akshare-trial data-source pipeline storage acceptance smoke lint format-check test frontend-test frontend-build ci-local
